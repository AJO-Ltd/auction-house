...
export default class AuctionHouseSdk {
    ...
    findTradeState(wallet: PublicKey, tokenAccount: PublicKey, tokenMint: PublicKey, priceInLamports: number, tokenSize?: number): Promise<[PublicKey, number, import("bn.js")]>;
